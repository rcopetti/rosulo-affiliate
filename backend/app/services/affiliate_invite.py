...
async def accept_invite(
    ...
    if account:
        ...
        acct_data = AffiliateAccountCreate(
            ...
            postal_code=data.postal_code or account.postal_code,
            tax_id=account.tax_id,
            tax_status=data.tax_status or account.tax_status,
            tax_entity_type=data.tax_entity_type or account.tax_entity_type,
            business_name=data.business_name or account.business_name,
...
async def accept_invite_token(
    ...
    acct_data = AffiliateAccountCreate(
        ...
        tax_entity_type=account.tax_entity_type,
